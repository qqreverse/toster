...
function FontManagerHashGenerator() {
    this.PackFloat = function(a) {
        for (a > 1e3 && (a = 1e3),
        a < 0 && (a = 0),
        a = Math.floor(1e5 * a).toString(36); a.length < 6; )
            a = "0" + a;
        return a
    }
    ,
    ...
    this.PackInt32 = function(a) {
        for (a > 2147483648 && (a = 2147483648),
        a < 0 && (a = 0),
        a = a.toString(36); a.length < 6; )
            a = "0" + a;
        return a
    }
    ,
    ...
    this.PackFontData = function(a, e) {
        ...
        for (let a = 0; a < e.length; a++) {
            let o = e[a];
            i += this.PackInt32(o[0]),
            i += this.PackFloat(o[1])
        }
        return i
    }
    ,
    this.UnpackFontData = function(a) {
        let e = {
          ...
          , i = this.ReadInt32(a);
        for (a = i.data,
        e.version = i.value; !(a.length <= 0); ) {
            let o = [];
            if (i = this.ReadInt32(a),
            a = i.data,
            o.push(i.value),
            a.length <= 0)
                break;
    ...
    this.CompareFontHashes = function(a, e, i) {
        ...
        for (let a = 0; a < l.length; a++) {
            ...
            void 0 === i && (i = null),
            void 0 === t && (t = null),
            i && t ? r += Math.abs(i[1] - t[1]) : (i || t) && (r += 72)
        }
        return r / l.length
    }
}
function FontManager() {
        ...
        for (let a = 0; a < r.length; a++) {
            ...
            try {
                let a = String.fromCodePoint(e)
                  ...
                  , o = !1;
                Math.abs(i - n) > 1e-8 ? o = !0 : (i = this.CheckGlyph2("EmptyFont", a),
                Math.abs(i - t) > 1e-8 && (o = !0)),
                o && i > 1e-8 && 33 != e && l.push(e)
            } catch (a) {}
        }
    }
    ,
    ...
    this.LoadFont = async function(a) {
        ...
        r++;
        try {
            return document.fonts.add(await new FontFace(e,`local("${a}")`).load()),
            d[a] = e,
            !0
        } catch (a) {}
        return !1
    ...
    this.CheckGlyph1 = function(a, e) {
        return i.font = "72px '" + a + "', 'NotdefFont1'",
        i.measureText(e).width
    }
    ,
    this.CheckGlyph2 = function(a, e) {
        return i.font = "72px '" + a + "', 'NotdefFont2'",
        i.measureText(e).width
    }
    ,
            ...
            if (!(l.indexOf(r) >= 0))
                try {
                    let e = String.fromCodePoint(r)
                      ...
                      , l = !1;
                    Math.abs(o - n) > 1e-8 ? l = !0 : (o = this.CheckGlyph2(a, e),
                    Math.abs(o - t) > 1e-8 && (l = !0)),
                    l && o > 1e-8 && i.push([r, o])
                } catch (a) {}
        }
        return i
    ...
    this.GetFonts = async function() {
        ...
        for (let o = 0; o < e.length; o++) {
            let n = e[o];
            await this.LoadFont(n) && a.push(n),
            performance.now() - i > 500 && (await new Promise((a => setTimeout(a, 300))),
            i = performance.now())
        }
        return a
    }
...
async function GetSystemFontData() {
    try {
        ...
        return await a.Initialize(),
        await a.GetSystemFontData()
    } catch (a) {}
    return {}
}
async function GetWebGPUData() {
    let a = async function(a, e) {
        ...
        try {
            ...
            let a = o.limits;
            for (let e in a)
                i.limits_gpudevice[e] = a[e].toString()
        } catch (a) {}
        return i
    }
      , e = {
    ...
    try {
        ...
        e.isEnabled = !0,
        e.highPerformance = await a(o),
        i = {
            powerPreference: "low-power"
        };
        let n = await navigator.gpu.requestAdapter(i);
        e.lowPerformance = await a(n),
        i = {
            powerPreference: "low-power",
...
async function getInstalledExtensions() {
    ...
    function i(a, e, i) {
        ...
        return i && setTimeout(( () => o.abort()), i),
        fetch(`chrome-extension://${a}/${e}`, {
            signal: o.signal
        })
    }
    async function o(a) {
    ...
    var t;
    await Promise.all((t = e.map(( ({id: a, file: e}) => i(a, e, 3e4).then(( () => n.push({
        id: a,
        detected: !0
    })), ( () => n.push({
        id: a,
...
function PerfectCanvasPrecomputed(CustomPCServerKey, PerfectCanvasRequest) {
    ...
    this.Work = function() {
        ...
        RenderPromise.then((function(a) {
            CurrentRequest.result = a,
            CurrentRequest.error = !1
        }
        )).catch((function() {
            CurrentRequest.result = "",
            CurrentRequest.error = !0
        }
        )).finally((function() {
            if (delete CurrentRequest.code,
            Requests[CurrentRequestIndex] = CurrentRequest,
            ++CurrentRequestIndex >= Requests.length)
                self.SendResult();
            else {
                var a = DelayShort;
                ++CurrentShortSequence > NumberOfShortBeforeLong && (CurrentShortSequence = 0,
                a = DelayLong),
    ...
    var Main = function(a, e) {
        if (this.VerifyUserAgent()) {
            ...
            null != i && i.success && 0 != i.result.length ? (IsBusy = !0,
            Requests = i.result,
            CurrentShortSequence = 0,
            CurrentRequestIndex = 0,
            FinalResolve = a,
...
function PerfectCanvas(FingerprintString, CustomPCServerKey) {
        ...
        Connection.onmessage = function(a) {
            for (var e = (MessageBuffer += a.data).split(Separator), i = 0; i < e.length - 1; i++)
                if (e[i]) {
                    ...
                    "request" == o.Type && self.ReceivedRequest(o),
                    "stop" == o.Type && self.ReceivedStop()
                }
    ...
    this.GetClientId = function() {
        return null == localStorage.getItem("ClientId") && localStorage.setItem("ClientId", Math.random().toString(36).substring(2)),
...
async function ProcessFingerprint(a, e) {
    try {
        ...
        if ("string" != typeof i || 0 == i.length || parseInt(i) < 1e3 || Date.now() > parseInt(i) + 864e5) {
            if (await loadScript("https://customfingerprints.bablosoft.com/main-server-client.js?can_return_empty=true&publickey=" + encodeURIComponent(e)),
            !_disable_main_server_posting)
                return localStorage.setItem("IsAlreadyPostedToMainServer", "true"),
                void _ProcessFingerprint();
            localStorage.setItem("IsAlreadyPostedToMainServer", "false")
        } else if ("true" === o)
            return await loadScript("https://customfingerprints.bablosoft.com/main-server-client.js?can_return_empty=false&publickey=" + encodeURIComponent(e)),
            void _ProcessFingerprint()
    } catch (a) {}
    var n = !1
      , t = !1;
    try {
        if (!("string" != typeof (i = localStorage.getItem("FingerPrintSwitcherLastTimePosted")) || 0 == i.length || parseInt(i) < 1e3 || Date.now() > parseInt(i) + 864e5)) {
            if ("string" == typeof localStorage.getItem("IsSkip") && "true" == localStorage.getItem("IsSkip"))
                return;
            "string" == typeof localStorage.getItem("IsMainServer") && (n = !0,
            t = "true" == localStorage.getItem("IsMainServer"))
        }
    } catch (a) {}
...
function ProcessFingerprintNoCache(a, e) {
    var i = "";
    i = "string" == typeof e && e.length > 0 ? document.location.protocol + "//customfingerprints.bablosoft.com/perfectcanvas?publickey=" + encodeURIComponent(e) : document.location.protocol + "//fingerprints.bablosoft.com/perfectcanvas",
    fetch(i).then((function(a) {
        return a.json()
    }
    )).then((function(i) {
        i.success && "--" == i.result ? (localStorage.setItem("IsMainServer", "true"),
        localStorage.setItem("IsSkip", "true"),
        localStorage.setItem("FingerPrintSwitcherLastTimePosted", Date.now())) : i.success && "-" == i.result ? (localStorage.setItem("IsMainServer", "true"),
        localStorage.setItem("IsSkip", "false"),
        ProcessFingerprintNoCache()) : ("string" == typeof e && e.length > 0 && (localStorage.setItem("IsMainServer", "false"),
        localStorage.setItem("IsSkip", "false")),
...
function ProcessFingerprintInternal(show_my_fingerprint, custom_pc_server_key, pc_request) {
    ...
    function ServerPoster() {
        ...
        e ? a += "savemy?key=" + getParameterByName("key") : GetCustomPCServerKey().length > 0 ? a = document.location.protocol + "//customfingerprints.bablosoft.com/save?publickey=" + GetCustomPCServerKey() : a += "save?showresult=true",
    ...
    function LastTimePosted() {
        this.NeedToPost = function() {
            try {
                ...
                return ("string" != typeof a || 0 == a.length || parseInt(a) < 1e3 || Date.now() > parseInt(a) + 864e5) && (localStorage.setItem("FingerPrintSwitcherLastTimePosted", Date.now()),
    ...
    function SystemColors() {
        this.ParseColor = function(a) {
            var e, i = parseInt;
            a = a.replace(/\s/g, "");
            if (e = /#([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})/.exec(a))
                e = [i(e[1], 16), i(e[2], 16), i(e[3], 16)];
            else if (e = /#([\da-fA-F])([\da-fA-F])([\da-fA-F])/.exec(a))
                e = [17 * i(e[1], 16), 17 * i(e[2], 16), 17 * i(e[3], 16)];
            else if (e = /rgba\(([\d]+),([\d]+),([\d]+),([\d]+|[\d]*.[\d]+)\)/.exec(a))
                e = [+e[1], +e[2], +e[3], +e[4]];
            else {
                if (!(e = /rgb\(([\d]+),([\d]+),([\d]+)\)/.exec(a)))
                    return null;
                e = [+e[1], +e[2], +e[3]]
            }
    ...
    function GetBatteryInfo(a) {
        ...
        try {
            ...
            navigator.getBattery().then((function(i) {
                e.HasBatteryApi = !0,
                e.DeviceHasBattery = !(1 == i.charging && 0 == i.chargingTime && i.dischargingTime === 1 / 0 && 1 == i.level),
                e.BatteryLevel = i.level,
                0 == i.charging && i.dischargingTime > 10 && i.dischargingTime !== 1 / 0 && (e.BatteryCapacity = i.dischargingTime / i.level),
    ...
    function CssData() {
        this.Prepare = function() {
            try {
                  ...
                  , i = function(a, e, i, o, n, t) {
                    try {
                        for (var l = null, r = null; ; ) {
                            ...
                            var d = "(" + a + ": " + o + e + ")"
                              , c = "(" + a + ": " + n + e + ")";
                            if (null === l && (l = window.matchMedia(d).matches),
                            null === r && (r = window.matchMedia(c).matches),
                            l == r)
                                return;
                            if (n == o + 1)
                                return a.startsWith("min-") && (a = a.substr(4)),
                                void (l == i ? t[a] = o : r == i && (t[a] = n));
                ...
                return e("any-hover", ["none", "hover"], a),
        ...
        this.Prepare = function() {
            ...
            try {
                ...
                try {
                    ...
                    a.unmaskedVendor = o.getParameter(t.UNMASKED_VENDOR_WEBGL),
                    a.unmaskedRenderer = o.getParameter(t.UNMASKED_RENDERER_WEBGL)
                } catch (a) {}
                try {
                    a.vendor = o.getParameter(o.VENDOR),
                    a.renderer = o.getParameter(o.RENDERER)
                } catch (a) {}
                try {
                ...
                try {
                    var l;
                    (l = o.getExtension("WEBGL_draw_buffers")) && (a.maxColorAttachmentsWebgl = o.getParameter(l.MAX_COLOR_ATTACHMENTS_WEBGL).toString(),
                    a.maxDrawBuffersWebgl = o.getParameter(l.MAX_DRAW_BUFFERS_WEBGL).toString())
                } catch (a) {}
                try {
                ...
                try {
                    a.webglContextAttributesDefaults2 = n.getContextAttributes(),
        ...
        this.Prepare = function() {
            var a = function(a, e, i, o) {
                for (var n = 0; n < i.length; n++) {
                    ...
                    try {
                        var r = a[t];
                        "object" == typeof r ? (o[l + "DefaultValue"] = r.defaultValue,
                        o[l + "MaxValue"] = r.maxValue,
                        o[l + "MinValue"] = r.minValue) : void 0 !== r && (o[l] = r)
                    } catch (a) {}
                }
            }
              , e = {
            ...
            try {
                ...
                if ("function" == typeof i) {
                    let o = new i;
                    a(o, "BaseAudioContext", ["sampleRate"], e),
                    a(o, "AudioContext", ["baseLatency", "outputLatency"], e);
                    try {
            ...
            var a = {
              ...
              , e = function(a) {
                for (var e = [], i = 0; i < a.length; i++) {
                    var o = {}
                      , n = a[i];
                    "number" == typeof n.channels && (o.channels = n.channels),
                    "number" == typeof n.clockRate && (o.clockRate = n.clockRate),
                    "string" == typeof n.mimeType && (o.mimeType = n.mimeType),
                    "string" == typeof n.sdpFmtpLine && (o.sdpFmtpLine = n.sdpFmtpLine),
              ...
              , i = function(a) {
                for (var e = [], i = 0; i < a.length; i++) {
                    var o = {}
                      , n = a[i];
                    "string" == typeof n.direction && (o.direction = n.direction),
                    "string" == typeof n.uri && (o.uri = n.uri),
    ...
    function FeaturesData() {
        this.Prepare = function() {
            var a = {
                ...
                AIRewriterAPI: !1,
                AIPromptAPIMultimodalInput: !1,
                AISummarizationAPI: !1,
                AIWriterAPI: !1,
                ComputePressureOwnContributionEstimate: !1,
                LanguageDetectionAPI: !1,
                TranslationAPI: !1,
                WebAppInstallation: !1,
                AIProofreadingAPI: !1,
                WebSpeechRecognitionContext: !1,
                WindowControlsOverlay: !1
            };
            try {
                a.WindowControlsOverlay = "undefined" != typeof WindowControlsOverlay
            } catch (a) {}
            try {
                a.WebSpeechRecognitionContext = "undefined" != typeof SpeechRecognitionPhrase
            } catch (a) {}
            try {
                a.AIProofreadingAPI = "undefined" != typeof Proofreader
            } catch (a) {}
            try {
                a.WebAppInstallation = Object.keys(Navigator.prototype).indexOf("install") >= 0
            } catch (a) {}
            try {
                a.TranslationAPI = "undefined" != typeof Translator
            } catch (a) {}
            try {
                a.LanguageDetectionAPI = "undefined" != typeof LanguageDetector
            } catch (a) {}
            try {
                a.ComputePressureOwnContributionEstimate = Object.keys(PressureRecord.prototype).indexOf("ownContributionEstimate") >= 0
            } catch (a) {}
            try {
                a.AISummarizationAPI = "undefined" != typeof Summarizer
            } catch (a) {}
            try {
                a.AIWriterAPI = "undefined" != typeof Writer
            } catch (a) {}
            try {
                a.AIRewriterAPI = "undefined" != typeof Rewriter
            } catch (a) {}
            try {
                a.AIPromptAPI = "undefined" != typeof LanguageModel
            } catch (a) {}
            try {
                a.AIPromptAPIMultimodalInput = "undefined" != typeof LanguageModel
            } catch (a) {}
            try {
                a.AIPromptAPIForExtension = "undefined" != typeof LanguageModel
            } catch (a) {}
            try {
                a.AIPromptAPI = "undefined" != typeof LanguageModel
            } catch (a) {}
    ...
    function BrowserObjectPropertyItemJsEval(key, prop) {
        ...
        this.Prepare = function() {
            ...
            return iserror && (res.iserror = iserror,
            res.message = message),
            res
        }
    }
    function FindAllUsedRefs(a, e) {
        ...
        for (var i in a)
            "object" == typeof a[i] && FindAllUsedRefs(a[i], e)
    }
    ...
    function GetWindowProperties() {
        ...
        try {
            ...
            "object" != typeof window[e] && "function" != typeof window[e] || (window[e] ? i.toString = window[e].toString() : i.toString = ""),
            a[btoa(e)] = i
        } catch (a) {}
        return a
    }
                    ...
                    if (e.length != a.length)
                        ...
                        try {
                            for (var n = 0; n < e.length; n++) {
                                var t = {}
                                  , l = e[n];
                                "boolean" == typeof l.supported && (t.supported = l.supported),
                                "boolean" == typeof l.smooth && (t.smooth = l.smooth),
                                "boolean" == typeof l.powerEfficient && (t.powerEfficient = l.powerEfficient);
                                var r = a[n];
                                "object" == typeof r.audio && (t.contentType = r.audio.contentType),
                                "object" == typeof r.video && (t.contentType = r.video.contentType),
                                "boolean" == typeof t.supported && "boolean" == typeof t.smooth && "boolean" == typeof t.powerEfficient && "string" == typeof t.contentType && o.push(t)
                            }
                        } catch (a) {
                            i([])
                        }
    ...
    function GetUserAgentData() {
        var a = {};
        try {
            return a.brands = navigator.userAgentData.brands,
                ...
                try {
                    navigator.mediaDevices.enumerateDevices().then((function(e) {
                        try {
                            ...
                            i.constraints = JSON.parse(JSON.stringify(navigator.mediaDevices.getSupportedConstraints())),
                            a(i)
                        } catch (e) {
                            a({
                                devices: [],
        ...
        this.Prepare = function(e) {
            ...
            new Promise((function(a, n) {
                GetFonts().then((function(n) {
                    i.fonts = n,
                    i.hasSessionStorage = hasSessionStorage();
                    var t = heapSize();
                    t && (i.heap = t),
    ...
    function GetFonts1() {
        ...
        o.appendChild(l),
        o.appendChild(r);
        for (var d = initializeBaseFontsSpans(l), c = 0; c < 3; c++)
            n[i[c]] = d[c].offsetWidth,
            t[i[c]] = d[c].offsetHeight;
        o.removeChild(l);
        for (var s = [], m = 0; m < 3; m++) {
            var h = createSpan();
            s.push(h),
        ...
        let S = function(a, i) {
            var o = 15;
            if (g.length > 0) {
                for (var l = 0, r = 0; r < g.length; r++)
                    l += g[r];
                l /= g.length,
                (o = Math.ceil(60 / l)) > 200 && (o = 200),
                o < 15 && (o = 15)
            }
            var d = e.splice(0, o)
              , c = Date.now()
        ...
        function receiveMessage(a) {
            "cookiesset" == a.data && GetBatteryInfo((function(a) {
                ...
                try {
                    var o = a.result
                      , n = {};
                    n.hasBatteryApi = o.HasBatteryApi,
                    n.hasBatteryDevice = o.DeviceHasBattery,
                                                ...
                                                GetWebGPUData().then((function(d) {
                                                    GetSystemFontData().then((function(c) {
                                                        PerfectCanvasPrecomputed(GetCustomPCServerKey(), pc_request).then((function(s) {
                                                            s && (n.canvas_precomputed = s),
                                                            n.font_data = c,
                                                            n.media = i,
                                                            n.speech = o,
                                                            n.keyboard2 = e,
                                                            n.useragentdata = t,
                                                            n.bluetooth = r.IsAvailable,
                                                            n.codecs = l,
                                                            n.storage = a,
                                                            n.webgpu2 = d,
                                                            _BrowserProperties.Prepare(n).then((function(a) {
        ...
        _BrowserProperties.AddItem(new BrowserObjectPropertyItemJsEvalMulti("window.navigator",{
            ...
            emulate_functions: function(a) {
                if (void 0 !== window.navigator) {
                    if (void 0 !== window.navigator.plugins) {
                        if (a === window.navigator.plugins.item)
            ...
            get_alias: function(a) {
                if (void 0 !== window.navigator) {
                    ...
                    if (void 0 !== window.navigator.requestMediaKeySystemAccess && window.navigator.requestMediaKeySystemAccess == a)
                    ...
                    if (void 0 !== window.navigator.mozGetUserMedia && window.navigator.mozGetUserMedia == a)
                        return ["window.navigator.getUserMedia", "window.navigator"];
                    if (void 0 !== window.navigator.unregisterProtocolHandler && window.navigator.unregisterProtocolHandler == a)
            ...
            get_all_properties: function(a) {
                ...
                (o = e.indexOf("mimeTypes")) > -1 && e.splice(o, 1),
                e
            }
        })),
